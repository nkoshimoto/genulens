...
PYBIND11_MODULE(genulens, m)
{
    ...
    py::class_<genulens::Event>(m, "Event")
        ...
        .def_readonly("piEN", &genulens::Event::piEN)
        .def_readonly("piEE", &genulens::Event::piEE)
        ...
        .def_readonly("mu_rel_N_masyr", &genulens::Event::mu_rel_N_masyr)
        .def_readonly("mu_rel_E_masyr", &genulens::Event::mu_rel_E_masyr)
        .def_readonly("source_mu_l_masyr", &genulens::Event::source_mu_l_masyr)
        .def_readonly("source_mu_b_masyr", &genulens::Event::source_mu_b_masyr)
        .def_readonly("lens_i_mag", &genulens::Event::lens_i_mag)
        .def_readonly("lens_k_mag", &genulens::Event::lens_k_mag)
        .def_readonly("lens_component", &genulens::Event::lens_component)
        .def_readonly("source_component", &genulens::Event::source_component)
        .def_readonly("remnant_flag", &genulens::Event::remnant_flag)
        .def_readonly("source_age_gyr", &genulens::Event::source_age_gyr)
        .def_readonly("lens_age_gyr", &genulens::Event::lens_age_gyr)
